...
export default function FeaturesSection() {
  ...
  return (
    <>
      <section className="py-24 dark:bg-gray-900" id="features">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 lg:mb-16 flex justify-center items-center flex-col gap-x-0 gap-y-6 lg:gap-y-0 lg:flex-row lg:justify-between max-md:max-w-lg max-md:mx-auto">
            <div className="relative w-full text-center lg:text-left lg:w-2/4">
              <h2 className="text-4xl font-bold text-gray-900 dark:text-gray-100 leading-[3.25rem] lg:mb-6 mx-auto max-w-max lg:max-w-md lg:mx-0">
                {isEnglish ? "Experience the Best Car Rental Services" : "اختبر أفضل خدمات تأجير السيارات"}
              </h2>
            </div>
            <div className="relative w-full text-center lg:text-left lg:w-2/4">
              <p className="text-lg font-normal text-gray-500 dark:text-gray-300 mb-5">
                {isEnglish ? "We offer a wide range of vehicles and exceptional customer service to make your rental experience seamless and enjoyable." : "نحن نقدم مجموعة واسعة من المركبات وخدمة عملاء استثنائية لجعل تجربة تأجيرك سلسة وممتعة."}
              </p>
              <a
                href="#search-car"
                className="flex flex-row items-center justify-center gap-2 text-base font-semibold text-brand-600 dark:text-brand-400 lg:justify-start hover:text-brand-700 dark:hover:text-brand-500"
              >
                {isEnglish ? "Rent a Car Now" : "استأجر سيارة الآن"}{" "}
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
          ...
          <div className="flex justify-center items-center gap-x-5 gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
            <div className="group relative w-full bg-gray-100 dark:bg-gray-800 rounded-2xl p-4 transition-all duration-500 max-md:max-w-md max-md:mx-auto md:w-2/5 md:h-64 xl:p-7 xl:w-1/4 hover:bg-brand-600 dark:hover:bg-brand-500">
              ...
              <h4 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3 capitalize transition-all duration-500 group-hover:text-white">
                {isEnglish ? "Easy Booking" : "حجز سهل"}
              </h4>
              <p className="text-sm font-normal text-gray-500 dark:text-gray-300 transition-all duration-500 leading-5 group-hover:text-white">
                {isEnglish ? "Book your car rental easily through our user-friendly platform." : "احجز تأجير سيارتك بسهولة من خلال منصتنا سهلة الاستخدام."}
              </p>
            </div>
            <div className="group relative w-full bg-gray-100 dark:bg-gray-800 rounded-2xl p-4 transition-all duration-500 max-md:max-w-md max-md:mx-auto md:w-2/5 md:h-64 xl:p-7 xl:w-1/4 hover:bg-brand-600 dark:hover:bg-brand-500">
              <div className="bg-white dark:bg-gray-700 rounded-full flex justify-center items-center mb-5 w-14 h-14">
              ...
              <h4 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3 capitalize transition-all duration-500 group-hover:text-white">
                {isEnglish ? "Secure Rentals" : "تأجير آمن"}
              </h4>
              <p className="text-sm font-normal text-gray-500 dark:text-gray-300 transition-all duration-500 leading-5 group-hover:text-white">
                {isEnglish ? "Our rental process ensures the safety and security of all transactions." : "تضمن عملية التأجير لدينا سلامة وأمان جميع المعاملات."}
              </p>
            </div>
            <div className="group relative w-full bg-gray-100 dark:bg-gray-800 rounded-2xl p-4 transition-all duration-500 max-md:max-w-md max-md:mx-auto md:w-2/5 md:h-64 xl:p-7 xl:w-1/4 hover:bg-brand-600 dark:hover:bg-brand-500">
              <div className="bg-white dark:bg-gray-700 rounded-full flex justify-center items-center mb-5 w-14 h-14">
              ...
              <h4 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3 capitalize transition-all duration-500 group-hover:text-white">
                {isEnglish ? "24/7 Support" : "دعم 24/7"}
              </h4>
              <p className="text-sm font-normal text-gray-500 dark:text-gray-300 transition-all duration-500 leading-5 group-hover:text-white">
                {isEnglish ? "Our customer service team is available 24/7 to assist you with any issues." : "فريق خدمة العملاء لدينا متاح على مدار الساعة لمساعدتك في أي مشاكل."}
              </p>
            </div>
            <div className="group relative w-full bg-gray-100 dark:bg-gray-800 rounded-2xl p-4 transition-all duration-500 max-md:max-w-md max-md:mx-auto md:w-2/5 md:h-64 xl:p-7 xl:w-1/4 hover:bg-brand-600 dark:hover:bg-brand-500">
              <div className="bg-white dark:bg-gray-700 rounded-full flex justify-center items-center mb-5 w-14 h-14">
              ...
              <h4 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3 capitalize transition-all duration-500 group-hover:text-white">
                {isEnglish ? "Fast Transactions" : "معاملات سريعة"}
              </h4>
              <p className="text-sm font-normal text-gray-500 dark:text-gray-300 transition-all duration-500 leading-5 group-hover:text-white">
                {isEnglish ? "Enjoy quick and hassle-free transactions with our efficient system." : "استمتع بمعاملات سريعة وسهلة مع نظامنا الفعال."}
              </p>
            </div>
          </div>
        </div>
