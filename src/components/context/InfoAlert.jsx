...
export default function InfoAlert({ onClose, onConfirm, title, message }) {
          ...
          <div className="relative w-full mx-auto max-w-[600px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
            <div className="text-center">
              <div class="relative flex items-center justify-center z-1 mb-7">
                <svg
                  class="fill-blue-light-50 dark:fill-blue-light-500/15"
                  width="90"
                  height="90"
                  viewBox="0 0 90 90"
                  fill="none"
              ...
              <div className="flex items-center justify-center w-full gap-3 mt-7">
                <button
                  type="button"
                  class="flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-blue-light-500 shadow-theme-xs hover:bg-blue-light-600 dark:bg-blue-light-700 dark:hover:bg-blue-light-800 sm:w-auto"
                  onClick={onClose}
                >
