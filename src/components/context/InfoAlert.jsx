          ...
          <div className="relative w-full mx-auto max-w-[600px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
            <div className="text-center">
              ...
              <div className="flex items-center justify-center w-full gap-3 mt-7">
                <button
                  type="button"
                  className="flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-blue-light-500 shadow-theme-xs hover:bg-blue-light-600 dark:bg-blue-light-700 dark:hover:bg-blue-light-800 sm:w-auto"
                  onClick={onClose}
                >
